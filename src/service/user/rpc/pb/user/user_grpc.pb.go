...
const (
	...
	User_SetUserAvatarFileId_FullMethodName    = "/userclient.User/SetUserAvatarFileId"
	User_GetUserAvatarFileId_FullMethodName    = "/userclient.User/GetUserAvatarFileId"
)
...
func (c *userClient) SetUserAvatarFileId(ctx context.Context, in *SetUserAvatarFileIdRequest, opts ...grpc.CallOption) (*SetUserAvatarFileIdResponse, error) {
	out := new(SetUserAvatarFileIdResponse)
	err := c.cc.Invoke(ctx, User_SetUserAvatarFileId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetUserAvatarFileId(ctx context.Context, in *GetUserAvatarFileIdRequest, opts ...grpc.CallOption) (*GetUserAvatarFileIdResponse, error) {
	out := new(GetUserAvatarFileIdResponse)
	err := c.cc.Invoke(ctx, User_GetUserAvatarFileId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	SetUserAvatarFileId(context.Context, *SetUserAvatarFileIdRequest) (*SetUserAvatarFileIdResponse, error)
	GetUserAvatarFileId(context.Context, *GetUserAvatarFileIdRequest) (*GetUserAvatarFileIdResponse, error)
...
func (UnimplementedUserServer) SetUserAvatarFileId(context.Context, *SetUserAvatarFileIdRequest) (*SetUserAvatarFileIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetUserAvatarFileId not implemented")
}
func (UnimplementedUserServer) GetUserAvatarFileId(context.Context, *GetUserAvatarFileIdRequest) (*GetUserAvatarFileIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserAvatarFileId not implemented")
}
...
func _User_SetUserAvatarFileId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetUserAvatarFileIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).SetUserAvatarFileId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_SetUserAvatarFileId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).SetUserAvatarFileId(ctx, req.(*SetUserAvatarFileIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _User_GetUserAvatarFileId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserAvatarFileIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetUserAvatarFileId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetUserAvatarFileId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserAvatarFileId(ctx, req.(*GetUserAvatarFileIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetUserAvatarFileId",
			Handler:    _User_SetUserAvatarFileId_Handler,
		},
		{
			MethodName: "GetUserAvatarFileId",
			Handler:    _User_GetUserAvatarFileId_Handler,
		},
	},
