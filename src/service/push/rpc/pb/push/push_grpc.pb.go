...
const (
	Push_PushToUser_FullMethodName = "/pushclient.Push/PushToUser"
)
...
func (c *pushClient) PushToUser(ctx context.Context, in *PushToUserRequest, opts ...grpc.CallOption) (*PushToUserResponse, error) {
	out := new(PushToUserResponse)
	err := c.cc.Invoke(ctx, Push_PushToUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPushServer) PushToUser(context.Context, *PushToUserRequest) (*PushToUserResponse, error) {
...
func _Push_PushToUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PushToUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PushServer).PushToUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Push_PushToUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PushServer).PushToUser(ctx, req.(*PushToUserRequest))
	}
...
var Push_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pushclient.Push",
	HandlerType: (*PushServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PushToUser",
			Handler:    _Push_PushToUser_Handler,
		},
	},
