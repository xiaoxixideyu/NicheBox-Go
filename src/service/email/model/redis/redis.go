...
func (r *RedisInterface) SetVerificationCode(ctx context.Context, destination, code string, expiration int) error {
	return r.rds.SetexCtx(ctx, destination, code, expiration)
}
